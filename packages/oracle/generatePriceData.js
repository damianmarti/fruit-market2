  ...
  state.push({
    ...
    content:
      ...
      `
      {
        ...
        you'll use their lowercase name and give them a price that is fair relative to the other assets ranging from 0.1 credits each to 10 or even 15 credits each 
      `,
  });
